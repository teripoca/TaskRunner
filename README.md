...
> ℹ️ **本启动器只做一件事：按顺序把这些游戏脚本「打开 → 点开始 → 监控跑完 → 关掉」。**
> 它本身**不决定每个游戏具体跑哪些日常**——MAA / Maa_bbb / March7th / OneDragon / MaaEnd 里要跑哪些任务，需要你**自己进对应软件单独勾选设置好**；启动器只是按时把它们挨个启动而已。
...
- 你自己装好这些游戏自动化工具（放到任意目录都行）：
  ...
  - **Maa_bbb**（崩坏3，识宝小助手）：<https://github.com/miaojiuqing/Maa_bbb>
  - **March7th**（崩坏：星穹铁道，三月七小助手）：<https://github.com/moesnow/March7thAssistant>
  - **OneDragon**（绝区零一条龙）：<https://one-dragon.com/zzz/zh/home.html>
  - **MaaEnd**（终末地）：<https://maaend.com/>
